...
- **1768 train / 832 test.** Source = 80 quantized observed genes `O000…O079` (0–31) + metadata. Target
...
- **Not character-level** — char-level edit/LCS score the same predictions at **0.45–0.53**, far above LB.
